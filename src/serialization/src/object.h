...
/** Modified to include a serialization method by eldrid.s@husky.neu.edu and shetty.y@husky.neu.edu */
...
public:
    ...
    /** Return a serialized char* representation of the object */
    virtual char* serialize() { return ""; }
}; 
